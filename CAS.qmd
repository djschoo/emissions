...
<!-- , which provides a provincial framework for tracking and reporting energy and greenhouse gas emissions. The CEEI is intended to provide a cost-effective, rigorous and flexible data collection, analysis and reporting system for B.C. local governments and other interested parties.
-->
...
path = "C:/Users/thister/3D Objects/misc/Jobs/CAS/"
